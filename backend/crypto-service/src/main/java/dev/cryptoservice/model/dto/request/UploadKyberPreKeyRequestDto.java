...
@Schema(description = "Request DTO for uploading Kyber prekey.")
public record UploadKyberPreKeyRequestDto(
    @NotNull(message = "Key ID can't be empty.")
    @Positive(message = "Key ID must be positive.")
    @Schema(description = "Kyber prekey ID inside client local key store.", example = "1")
    Integer keyId,
    ...
    @Schema(description = "Optional Kyber prekey expiration datetime.")
